...
T: dict[str, dict[str, str]] = {
    ...
    "quick_pick_men_prompt":{"en": "I want the men's version (adult player or replica)",
                             "zh": "我要男士款（成人球员版/复刻版）",
                             "es": "Quiero la versión para hombres (adulto, jugador o réplica)",
                             "pt": "Quero a versão masculina (adulto, jogador ou réplica)",
                             "fr": "Je veux la version homme (adulte, joueur ou réplique)"},
    "quick_pick_women_label":{"en": "👩 Women's", "zh": "👩 女士款",
                              "es": "👩 Mujer", "pt": "👩 Feminino", "fr": "👩 Femme"},
    "quick_pick_women_prompt":{"en": "I want the women's version (women's cut)",
                               "zh": "我要女士款（女款剪裁）",
                               "es": "Quiero la versión para mujeres (corte femenino)",
                               "pt": "Quero a versão feminina (corte feminino)",
                               "fr": "Je veux la version femme (coupe féminine)"},
    "quick_pick_youth_label":{"en": "👦 Youth", "zh": "👦 青少年",
                              "es": "👦 Juvenil", "pt": "👦 Juvenil", "fr": "👦 Jeunesse"},
    "quick_pick_youth_prompt":{"en": "I want the youth/kids version",
                               "zh": "我要青少年/儿童款",
                               "es": "Quiero la versión juvenil/infantil",
                               "pt": "Quero a versão juvenil/infantil",
                               "fr": "Je veux la version jeunesse/enfant"},
    "quick_pick_family_label":{"en": "👨‍👩‍👧 Family", "zh": "👨‍👩‍👧 全家",
                               "es": "👨‍👩‍👧 Familia", "pt": "👨‍👩‍👧 Família", "fr": "👨‍👩‍👧 Famille"},
    "quick_pick_family_prompt":{"en": "Buying for the whole family — one for dad, mom, and the kid",
                                "zh": "给全家买 — 爸爸、妈妈、孩子一人一件",
                                "es": "Para toda la familia — uno para papá, mamá y el niño",
                                "pt": "Para toda a família — um para pai, mãe e a criança",
                                "fr": "Pour toute la famille — un pour papa, maman et l'enfant"},
